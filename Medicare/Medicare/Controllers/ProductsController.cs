...
namespace Medicare.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.Manufacturar).Include(p => p.ProductType);
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,ProductPrice,ProductQuantity,EntryDate,ProductTypeId,ManufacturerId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,ProductPrice,ProductQuantity,EntryDate,ProductTypeId,ManufacturerId")] Product product)
        {
            if (ModelState.IsValid)
            {
